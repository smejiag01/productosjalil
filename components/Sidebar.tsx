...
export default function Sidebar({ contactosPendientes = 0 }: { contactosPendientes?: number }) {
        ...
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.href === "/contactos-pendientes" && contactosPendientes > 0 && (
