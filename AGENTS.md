# AGENTS.md — Sistema de Pedidos WhatsApp · Productos Jalil

> Contexto del proyecto para Codex. Leer completo antes de empezar a trabajar.
...
En la carpeta `/disenos` de la raíz del proyecto hay imágenes de las pantallas diseñadas en Codex Design:
...
## Primeros pasos sugeridos para Codex
